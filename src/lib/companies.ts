...
<p>Factal sprang from the ashes of <a href="${companyUrl({ slug: 'breaking-news' })}">Breaking News</a>, a popular consumer service inside NBC News. Co-founded by Ben Tesch, Charlie Tillinghast and me, Factal launched in October 2018. Today its members include many of the largest companies in the world, spanning technology, finance, retail, insurance, health care, energy and other major sectors. I'm particularly proud that we provide Factal free to more than 300 humanitarian and disaster relief organizations, including the largest Red Cross teams around the world.</p>`,
	},
	{
		slug: 'breaking-news',
