...
pubDate: "Sep 27 2020"
tags: ["media", "journalism", "verification"]
canonical: "https://medium.com/@corybe/local-tvs-unusual-opportunity-to-inject-facts-into-filter-bubbles-8361de16d99a"
---

![](/blog-images/medium-local-tvs-unusual-opportunity-to-inject-facts-into-filter-bubbles-1.jpeg)

*Photo by [Tim Mossholder on UpSplash](https://unsplash.com/@timmossholder)*
...
But there is one large segment of the media ecosystem that spans the political divide: local TV news. While in a slow decline, local TV news outpaces newspapers, cable TV and network TV in both [total audience](https://www.journalism.org/fact-sheet/local-tv-news/) and [trust](https://www.poynter.org/ethics-trust/2018/finally-some-good-news-trust-in-news-is-up-especially-for-local-media/). On the digital side, local TV news has a thriving footprint, especially if you consider its outsized Facebook presence.
...
Some efforts are underway. [Tegna’s “Verify”](https://www.tegna.com/tegna-trains-journalists-to-combat-disinformation-in-2020/) combines fact-checking segments with journalism training initiatives. [Hearst’s “Commitment 2020”](https://markets.businessinsider.com/news/stocks/hearst-television-to-explore-issues-that-matter-to-voters-in-every-state-1028587321#) provides fact-checking across all 50 states in partnership with [FactCheck.org](http://www.factcheck.org). And there are a [few others](https://tvnewscheck.com/article/253233/as-election-nears-tvs-fact-checking-surges/), but so much more can be done.
...
(_I’ve worked in local, network and cable TV news. Now I’m co-founder of_[_Factal_](https://www.factal.com)_, a breaking news verification company._)
